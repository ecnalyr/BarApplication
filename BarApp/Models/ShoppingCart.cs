...
namespace BarApp.Models
{
    public class ShoppingCart
    {
        ...
        {
            // Multiply drink price by count of that drink to get 
            // the current price for each of those drinks in the cart
            // sum all drink price totals to get the cart total
            decimal? total = (from cartItems in storeDB.Carts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.Drinks.price).Sum();
